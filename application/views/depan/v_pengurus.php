...
<head>
    ...
    <title>Pengurus | KSR-PMI Unit 04 Unimal</title>
    ...
    <meta property="og:title" content="Pengurus | KSR-PMI Unit 04 Unimal" />
...
<!--//END HEADER -->
    ...
    <section class="our-teachers">  
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="mb-5">Pengurus Aktif</h2>
                </div>
            </div>
            <div class="row">
                <?php foreach ($data->result() as $row) : ?>
                    <div class="col-xs-12 col-sm-6 col-md-3">
                        <div class="admission_insruction">
                            ...
                            <p class="text-center mt-3"><?php echo $row->guru_nama;?>
                                <br>
                                <small><?php echo $row->guru_mapel;?></small>
                            </p>
                        </div>
                    </div>
                <?php endforeach;?>
