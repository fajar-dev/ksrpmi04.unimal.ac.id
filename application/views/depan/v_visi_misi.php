...
<head>
    ...
    <title>Visi Misi | KSR-PMI Unit 04 Unimal</title>
    ...
    <meta property="og:title" content="Visi Misi | KSR-PMI Unit 04 Unimal" />
...
<section class="welcome_about">
    <div class="container">
        <div class="row justify-content-center">
                <div class="col-md-12   ">
                    <h2>Visi-Misi dan Tujuan KSR-PMI Unit 04 Unimal</h2>
                    <h5>Visi</h5>
                    <p>Sebagai bagian dari Palang Merah Indonesia (PMI) KSR-PMI mempunyai visi kedepan membentuk sumberdaya masyarakat yang potensial dan strategis, sehingga para anggota KSR-PMI dituntut peka dan peran aktif untuk mampu menyediakan pelayanan kemanusia kepada masyarakat yang efektif dan tepat waktu.</p>
                </div>
                <div class="col-md-12">
                    <h5>Misi</h5>
                    <p> Sebagai organisasi yang consent memberikan sumbangsih kinerjanya tanpa pamrih, KSR-PMI mempunyai visi dan misi sebagai baerikut :</p>
                    <ol>
                        <li>Melaksanakan Pelayanan kepalangmerahan yang bermutu dan tepat sasaran mencakup :</li>
                        <ul>
                            <li>Bantu kemanusiaan dalam keadaan darurat</li>
                            <li>Pelayanan social dan kesehatan masyarakat</li>
                            <li>Usaha Transfusi Darah</li>
                        </ul>
                        <li>Pembinaan generasi muda dalam kepalang Merahan, kesehatan dan kesejahteraan.</li>
                        <li>Melakukan konsolidasi organisasi, pembinaan potensi dan peningkatan potensi sumber daya manusia untuk menghadapi situasi sesulit apapun</li>
                        <li>Menyebar dan mengembangkan aplikasi Prinsip Dasar Palang Merah dan Bulan bit Merah serta Hukum Perikemanusiaan Internasional (HPI) dimasyarakat .</li>
                    </ol>
                </div>
                <div class="col-md-12">
                    <h5>Tujuan</h5>
                    <ol>
                        <li>Memberikan wahana bagi para mahasiswa untuk mendharmabaktikan diri bagi tugas-tugas kepalang merahan dan kemanusiaan sebagai bentuk tanggung jawab kemasyarakat dan kebangsaan.</li>
                        <li>Menyiapakan mahasiswa sebagai kader Palang Merah Indonesia</li>
                        <li>Meningkatkan kebersamaan perjuangan Palang Merah Indonesia</li>
                        <li>Sebagai realisasi pelaksana semangat moral Dasar Palang Merah dan Bulan Sabit Merah Internasional dalam memberikan bantuan kepada yang membutuhkan.</li>
                        <li>Sebagai Sarana untuk turut serta membantu pemerintah serta pihak-pihak terkait yang peduli kemanusiaan.</li>
                    </ol>
                </div>
            </div>
        </div>
