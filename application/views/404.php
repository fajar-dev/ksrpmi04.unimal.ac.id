...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url().'theme/css/not-found.css'?>">
    <!-- Google Fonts -->
...
<div id="notfound">
		<div class="notfound">
			...
			<h1>404!</h1>
			<h2>oopss, ga ada apa apa disini !!</h2>
			<a class="text-danger pt-3"href="<?php echo base_url();?>"><i class="fa fa-long-arrow-left" aria-hidden="true"></i> Back to homepage</a>
		</div>
	</div>
